<template>
  <div class="h-screen bg-[#F7F8FA]">
    ...
    <div class="mx-auto py-6 px-5 max-w-7xl">
      ...
      <!--add product-->
      <div class="py-6">
        <nuxt-link class="py-3 flex justify-center items-center bg-[#4B1752] text-white font-bold rounded hover:bg-[#2C0531]" to="/admin/usages/add">
      ...
      <div class="border border-gray-200 rounded overflow-x-auto min-w-full bg-white">
        ...
        <table class="min-w-full text-sm align-middle whitespace-nowrap">
          ...
          <!-- Table Body -->
          <tbody v-for="(i,n) in applications" :key="n">
