<template>
  <div class="h-screen bg-[#F7F8FA]">
    ...
    <div class="mx-auto py-6 px-5 max-w-7xl">
      ...
      <h3 class="mr-2 py-2 font-bold text-xl underline decoration-4 decoration-[#FFB508] underline-offset-1">لیست سفارشات</h3>

      <!--add product-->
<!--      <div class="py-6">-->
<!--        <nuxt-link class="py-3 flex justify-center items-center bg-[#4B1752] text-white font-bold rounded hover:bg-[#2C0531]" to="/admin/products/addNewProduct">-->
...
<!--      </div>-->
      ...
      <div class="border border-gray-200 rounded overflow-x-auto min-w-full bg-white">
        ...
        <table class="min-w-full text-sm align-middle whitespace-nowrap">
          ...
          <!-- Table Body -->
          <tbody v-for="i in products" :key="i">
...
export default {
  ...
  mounted() {
    this.$store.dispatch('ingredients/getProducts')
  },

  computed: {
    products() {
      return this.$store.getters['ingredients/getProducts']
    },
  },
